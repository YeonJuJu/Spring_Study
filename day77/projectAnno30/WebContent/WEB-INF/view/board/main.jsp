			...
			<div class="card-body">
					...
					<tbody>
						<c:forEach var="contentDTO" items="${contentList }">
							...
							<tr>
								...
								<td><a
									href='${root }board/read?board_info_idx=${board_info_idx }&content_idx=${contentDTO.content_idx}'>${contentDTO.content_subject }</a></td>
				...
				<div class="d-none d-md-block">
					<ul class="pagination justify-content-center">
						<!--
				                       맨 처음 페이지인 경우에는 다음 버튼이 안 보이도록 함 
				                       최대페이지가 전체페이지개수보다 크면 다음이 안 보이도록 함 
                    	-->
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item"><a
									href="${root }board/main?board_info_idx=${board_info_idx}&page=${pageDTO.prePage}"
									class="page-link">이전</a></li>
							</c:otherwise>
						</c:choose>
                    ...
                    -->
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item"><a
									href="${root }board/main?board_info_idx=${board_info_idx}&page=${pageDTO.nextPage}"
									class="page-link">다음</a></li>
							</c:otherwise>
						</c:choose>
					</ul>
