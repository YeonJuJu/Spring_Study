...
import com.tjoeun.spring.interceptor.CheckWriterInterceptor;
  ...
  // Interceptor 등록하기
    ...
    WebMvcConfigurer.super.addInterceptors(registry);
  	...
  	CheckLoginInterceptor checkLoginInterceptor
  	  = new CheckLoginInterceptor(loginUserDTO);
  	...
  	InterceptorRegistration reg2
  	  = registry.addInterceptor(checkLoginInterceptor);
  	InterceptorRegistration reg3
